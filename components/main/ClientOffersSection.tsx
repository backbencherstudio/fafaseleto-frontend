  ...
  return (
    <section className="py-10 container mx-auto">
      ...
      <div className="relative mb-[51px]">
        ...
        <div>
          {/* RIGHT BUTTON = NEXT */}
          <button className="next-btn w-9 h-9 md:w-[50px] md:h-[50px] [background:var(--3,#10B981)] rounded-[50px] z-99 absolute   top-35 right-5 md:right-12 flex justify-center items-center cursor-pointer hover:border border-white transition-colors duration-200">
            <Image
          ...
          {/* LEFT BUTTON = PREV */}
          <button className="prev-btn w-9 h-9 md:w-[50px] md:h-[50px] [background:var(--3,#10B981)] rounded-[50px] z-99 absolute top-35 left-5 md:left-12 flex justify-center items-center cursor-pointer hover:border border-white transition-colors duration-200">
            <Image
